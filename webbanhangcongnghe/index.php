...
<link href="<?php echo URL_TEMPLATE_PART?>/css/style.css" rel="stylesheet" type="text/css" media="all"/>
<link href="<?php echo URL_TEMPLATE_PART?>/css/slider.css" rel="stylesheet" type="text/css" media="all"/>
	<style type="text/css">
		.categories .sub-menu{
			display: none;
			left: 260px;
...
<script type="text/javascript" src="<?php echo URL_TEMPLATE_PART?>/js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="<?php echo URL_TEMPLATE_PART?>/js/move-top.js"></script>
<script type="text/javascript" src="<?php echo URL_TEMPLATE_PART?>/js/easing.js"></script>
<script type="text/javascript" src="<?php echo URL_TEMPLATE_PART?>/js/startstop-slider.js"></script>
</head>
<body>
  <div class="wrap">
	<div class="header">
